...
def test_user():
    x = user.User(123456, "Vasiliy", "parazit@gmail.com",
...
def test_passes_id():
    with pytest.raises(Exception):
        user.User(" ", "dsds", "parazit@gmail.com",
                  1234, 5678, 9101112, 7889)


def test_passes_name():
    with pytest.raises(Exception):
        user.User(123456, " ", "parazit@gmail.com",
                  1234, 5678, 9101112, 7889)


def test_passes_email():
    with pytest.raises(Exception):
        user.User(123456, "dsds", " ",
                  1234, 5678, 9101112, 7889)


def test_passes_user_book_id():
    with pytest.raises(Exception):
        user.User(123456, "dsds", "parazit@gmail.com", " ")
...
def test_passes_id_short():
    with pytest.raises(Exception):
        user.User(123, "Vasiliy", "parazit@gmail.com",
                  1234, 5678, 9101112, 7889)


def test_passes_name_short():
    with pytest.raises(Exception):
        user.User(123456, "Vas", "parazit@gmail.com",
                  1234, 5678, 9101112, 7889)


def test_passes_email_short():
    with pytest.raises(Exception):
        user.User(123456, "Vasiliy", "par",
                  1234, 5678, 9101112, 7889)


def test_passes_user_book_id_short():
    with pytest.raises(Exception):
        user.User(123456, "Vasiliy", "parazit@gmail.com",
...
def test_passes_id_long():
    with pytest.raises(Exception):
        user.User(1234567891, "Vasiliy", "parazit@gmail.com",
                  1234, 5678, 9101112, 7889)


def test_passes_name_long():
    with pytest.raises(Exception):
        user.User(123456, "Vasiliygrtdefrt", "parazit@gmail.com",
                  1234, 5678, 9101112, 7889)


def test_passes_email_long():
    with pytest.raises(Exception):
        user.User(123456, "Vasiliy",
